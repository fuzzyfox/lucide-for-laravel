...
final class LucideFilamentServiceProvider extends ServiceProvider
{
    ...
    public static function aliasOverrides(): array
    {
        return [
            ...
            // Panels
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_DISABLE => Lucide::LockOpen,
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_DISABLE_MODAL => Lucide::LockOpen,
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_DISABLE_NOTIFICATION => Lucide::LockOpen,
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_REGENERATE_RECOVERY_CODES => Lucide::RefreshCw,
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_REGENERATE_RECOVERY_CODES_MODAL => Lucide::RefreshCw,
            PanelsIconAlias::AUTH_MULTI_FACTOR_APP_ACTIONS_REGENERATE_RECOVERY_CODES_NOTIFICATION => Lucide::RefreshCw,
            ...
            PanelsIconAlias::AUTH_MULTI_FACTOR_EMAIL_ACTIONS_DISABLE => Lucide::LockOpen,
            PanelsIconAlias::AUTH_MULTI_FACTOR_EMAIL_ACTIONS_DISABLE_MODAL => Lucide::LockOpen,
            PanelsIconAlias::AUTH_MULTI_FACTOR_EMAIL_ACTIONS_DISABLE_NOTIFICATION => Lucide::LockOpen,
            ...
            FormsIconAlias::COMPONENTS_MODAL_TABLE_SELECT_ACTIONS_SELECT => Lucide::SquarePen,
